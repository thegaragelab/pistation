...
BLOCK_WIDTH  = GENERAL_SPACE + LCD_OUTER_WIDTH + GENERAL_SPACE + BUTTON_DIAMETER + GENERAL_SPACE;
BLOCK_HEIGHT = GENERAL_SPACE + LCD_OUTER_HEIGHT + GENERAL_SPACE;
BLOCK_DEPTH  = LCD_OUTER_DEPTH + LCD_INNER_DEPTH;

TOTAL_BUTTON_HEIGHT = 4 * (BUTTON_DIAMETER + BUTTON_SPACE);
TOTAL_BUTTON_WIDTH  = BUTTON_DIAMETER;
